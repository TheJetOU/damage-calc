...
/**
 * Get which stat will be boosted by Quark Drive, Protosynthesis
 * In the case that `pokemon.boostedStat` is set, it will always return `pokemon.boostedStat`
